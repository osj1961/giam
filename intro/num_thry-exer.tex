...
\hint{The even numbered ones are 1 and 1287. The TI-84 calculates binomial coefficients. The symbol used is nCr (which is placed between the numbers -- i.e. it is an infix operator). You get nCr as the 3rd item in the PRB menu under MATH. In sage the command is {\tt binomial(n,k)}.}
