...
\begin{quote}
Any amount of postage greater than 7\textcent can be created
using some number of 3\textcent and some number of 5\cents stamps.
\end{quote}
...
\item (Exercise 2 in \section 5.1 in GIAM) What is wrong with the following
